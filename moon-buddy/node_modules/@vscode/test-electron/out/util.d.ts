...
export declare const isRunnableOnHost: (platform: string) => boolean;
...
export declare function insidersDownloadDirMetadata(dir: string, platform: DownloadPlatform, reporter: ProgressReporter, latestHash: string): {
    version: any;
    date: Date;
};
...
export declare function streamToBuffer(readable: NodeJS.ReadableStream): Promise<Buffer<ArrayBufferLike>>;
